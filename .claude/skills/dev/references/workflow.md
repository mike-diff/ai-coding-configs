...
In unattended mode there is **no human to answer questions** (e.g. `/dev` runs inside a GitHub Action triggered by an issue label). Every human-input gate is **SUSPENDED** and replaced with an autonomous behavior:
