...
> **Key Principle:** An agent running `/dev "Phase 1" @docs/specs/spec-[name].md` should have 100% of the context needed without reading other phases.
...
docs/specs/spec-auth.md (global context + N phases)
    ↓
/dev "Implement Phase 0" @docs/specs/spec-auth.md  →  Foundation complete
    ↓
/dev "Implement Phase 1" @docs/specs/spec-auth.md  →  Core auth complete
    ↓
/dev "Implement Phase N" @docs/specs/spec-auth.md  →  Polish complete
    ↓
Feature complete
```
