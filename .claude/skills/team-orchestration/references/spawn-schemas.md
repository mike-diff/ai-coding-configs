...
> spawning. The `/dev` and `/discuss` skills carry the **authoritative**,
...
> inline prompts — do not use these. Use the templates below only outside `/dev`
> and `/discuss`.
