---
name: primitives
description: "Enumerate all native Cursor tools, modes, and configuration primitives available in the current session. Use when verifying what tools are available before writing agents or hooks, or after a Cursor update."
disable-model-invocation: true
---

# /primitives — Tool Inventory
