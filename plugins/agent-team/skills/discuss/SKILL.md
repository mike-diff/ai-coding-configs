...
- Do NOT start implementing (`/agent-team:dev` is for that)
...
- ALWAYS end with an `<adlc-handoff>` block so `/agent-team:spec` can inherit the validated hypothesis, success metrics, risks, and human decision boundaries
