# /agent-team:spec — Template and Goal Condition Rule
...
Inherit from the /agent-team:discuss handoff when present.]
...
## Wrapup
*(appended by /agent-team:dev after implementation: what shipped, verification results, lessons,
follow-ups)*
```
...
Don't set a /goal on a phase /agent-team:dev is already driving — /agent-team:dev has its own verify gate.
```

## Living-document protocol

- `/agent-team:dev` sets `status: in-progress` when it starts and `implemented` at wrapup, and
