...
assert_file_contains "$spec_workflow" "No spec"
assert_file_contains "$spec_workflow" "Light spec"
assert_file_contains "$spec_workflow" "Full spec"
assert_file_contains "$spec_workflow" "## Requirement Contract"
assert_file_contains "$spec_workflow" "explicit approval"
assert_file_contains "$spec_workflow" "the only stop"
